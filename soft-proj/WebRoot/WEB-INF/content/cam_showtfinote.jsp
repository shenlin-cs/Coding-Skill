    ...
    <script type = "text/javascript" >
        ...
        window.onload = function () {
            ...
            if (getQueryVariable("NoteID") != false) {
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/gettfinote?",
                    dataType : "json",
                    data : {
                    ...
                    success:function(result){
                        $("#researcher_ID").html(result.data["researcher_ID"]);
                        $("#researcher_name").html(result.data["researcher_name"]);
                        $("#item_number").html(result.data["item_number"]);
                        $("#item_name").html(result.data["item_name"]);
                        $("#in_charge_person_ID").html(result.data["in_charge_person_ID"]);
                        $("#in_charge_person_name").html(result.data["in_charge_person_name"]);
                        $("#experimental_object").html(result.data["experimental_object"]);
                        $("#object_number").html(result.data["object_number"] +"<em>(单位：只)</em>");
                        $("#time").html(result.data["time"]);
                        $("#transferfromobject").html(result.data["transferfromobject"]);
                    },
            ...
            $(".search-btn").click(function () {
                ...
                $.ajax({
                    ...
                    success:function(result){
                        ...
                        {
                            $("#researcher_ID").html("");
                            $("#researcher_name").html("");
                            $("#item_number").html("");
                            $("#item_name").html("");
                            $("#in_charge_person_ID").html("");
                            $("#in_charge_person_name").html("");
                            $("#experimental_object").html("");
                            $("#object_number").html("");
                            $("#time").html("");
                            $("#transferfromobject").html("");
                        }
                    },
                    error: function (result) {
                        console.log("error: " + JSON.stringify(result));
        ...
        <div class="main" id="appArea">
            <div id="developer-index" class="tea-page-root">
                <div class="manage-area auth-info-page">
                    <div class="manage-area-title"><h2>转入记录详情</h2></div>
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                                            ...
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="researcher_ID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="researcher_name"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="item_number"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="item_name"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">工作人员基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>员工ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="in_charge_person_ID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>员工姓名</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="in_charge_person_name"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">实验动物转入信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转入平台名称</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="transferfromobject"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转入平台对象</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="experimental_object"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转入时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="time"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转入数量</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="object_number"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
