    ...
    <script type = "text/javascript" >
        ...
        window.onload = function () {
            ...
            if (getQueryVariable("NoteID") != false) {
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/gettfonote?",
                    dataType : "json",
                    data : {
                    ...
                    success:function(result){
                        ...
                        $("#transferobject").html(result.data["transferobject"]);
                    },
        ...
        <div class="main" id="appArea">
            <div id="developer-index" class="tea-page-root">
                <div class="manage-area auth-info-page">
                    <div class="manage-area-title"><h2>转出记录详情</h2></div>
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转出平台名称</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="transferobject"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转出平台对象</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转出时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                ...
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>转出数量</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
