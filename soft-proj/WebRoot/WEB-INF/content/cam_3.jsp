...
<head>
    ...
    <script type = "text/javascript" >
        ...
        window.onload = function () {
            ...
            if (getQueryVariable("ExperimentID") != false) {
                $.ajax({
                    type: "GET",
                    url: "http://localhost:8080/FileManage/api/getnotelisrt?",
                    dataType: "json",
                    data: {
                        ExperimentID: getQueryVariable("ExperimentID"),
                    ...
                    success: function (result) {
                        ...
                        if(val["type"]=="转入记录")
                        {
                        	type="cam_showtfinote";
                        }
                        else if(val["type"]=="转出记录")
                        {
                        	type="cam_showtfonote";
                        }
                        else if(val["type"]=="检查记录")
                        {
                        	type="cam_showchknote";
                        }
                        else if(val["type"]=="讨论记录")
                        {
                        	type="cam_showdisnote";
                        }
                        else if(val["type"]=="手术记录")
                        {
                        	type="cam_showoptnote";
                        }
                            ...
                            var list = "<tbody><tr data-tips=\"\">\n" +
                                ...
                                "                                            </td>\n" +
                                "                                            <td colspan=\"1\" >\n" +
                                "                                                <div>"+val["recordid"]+"</div>\n" +
                                "                                            </td>\n" +
                                "                                            <td colspan=\"1\" >\n" +
                                "                                                <div>" + val["staffid"] + "</div>\n" +
                                "                                            </td>\n" +
                                "                                            <td colspan=\"1\" >\n" +
                                "                                                <div>" + val["staffname"] + "</div>\n" +
                                "                                            </td>\n" +
                                "                                            <td colspan=\"1\" >\n" +
                                "                                                <div>" + val["type"] + "</div>\n" +
                                "                                            </td>\n" +
                                ...
                                "                                            </td>\n" +
                                "                                            <td colspan=\"1\" >\n" +
                                "                                                <div><a href=" +type + "?NoteID=" + val["recordid"] + "&token=" + sessionStorage.getItem("token") + ">查看详情</a></div>\n" +
                                "                                            </td>\n" +
                                "                                        </tr></tbody>";
                ...
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/getexperinfo?",
                    dataType : "json",
                    data : {
                        ExperimentID: getQueryVariable("ExperimentID"),
                        token: sessionStorage.getItem("token")
                    ...
                    async : false,
                    success:function(result){
                        $("#piid").html(result.data["piid"]);
                        $("#piname").html(result.data["piname"]);
                        $("#experimentID").html(result.data["experimentID"]);
                        $("#name").html(result.data["name"]);
                        $("#experimentStartTime").html(result.data["experimentStartTime"]);
                        $("#experimentEndTime").html(result.data["experimentEndTime"]);
                        $("#employeeID").html(result.data["employeeID"]);
                        $("#contact").html(result.data["contact"]);
                        $("#department").html(result.data["department"]);
                        $("#branchName").html(result.data["branchName"]);
                        $("#experimentPurpose").html(result.data["experimentPurpose"]);
                        $("#experimentContent").html(result.data["experimentContent"]);
                        $("#experimentStep").html(result.data["experimentStep"]);
                        $("#experimentConclusion").html(result.data["experimentConclusion"]);
                        $("#experimentNote").html(result.data["experimentNote"]);
                    },
                    error: function (result) {
                        console.log("error: " + JSON.stringify(result));
                    }
            ...
            $(".search-btn").click(function () {
                ...
                $.ajax({
                    ...
                    else
                    {
                        ...
                        $("#experimentID").html("");
                        $("#name").html("");
                        $("#experimentStartTime").html("");
                        $("#experimentEndTime").html("");
                        $("#employeeID").html("");
                        $("#contact").html("");
                        $("#department").html("");
                        $("#branchName").html("");
                        $("#experimentPurpose").html("");
                        $("#experimentContent").html("");
                        $("#experimentStep").html("");
                        $("#experimentConclusion").html("");
                        $("#experimentNote").html("");
                    }
                    },
                    error: function (result) {
    ...
    <style type="text/css">
        ...
        .panelgroup .tc-panel .tc-panel-hd {
            padding-left: 0;
            padding-right: 0;
            height: auto;
            margin-top: 10px;
                            ...
                            <div class="qc-tool-inner J-headerHelpWrapper">
                                ...
                                <div class="qc-tool-body J-helper-body" style="height: 729px;">
                                    <div class="qc-help-search-box"><input type="text" id="input_search_cont_help"
                                        ...
                                        <button type="button" class="qc-help-search-btn" id="qc-help-search-btn"></button>
                                    </div>
        ...
        <div class="main" id="appArea">
            <div id="developer-index" class="tea-page-root">
                <div class="manage-area auth-info-page">
                    <div class="manage-area-title"><h2>实验信息详情</h2></div>
                        ...
                        <div class="manage-area-main-inner">
                            ...
                            <div class="tc-15-action-panel">
                                ...
                                <div data-role="qc-search" class="search-box tc-15-search m" style="width: 320px;">
                                    <div class="search-input-wrap"><input type="text" placeholder="请输入动物ID查询"
                                                                          class="tc-15-input-text search-input" id="text">
                                ...
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">PI基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>PIID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="piid"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>PI姓名</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="piname"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">实验基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>实验ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="experimentID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>实验开始时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="experimentStartTime"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>实验名称</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                ...
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>实验完成时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="experimentEndTime"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">实验人员基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>负责人ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="employeeID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>部门</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="department"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="contact"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>分平台</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="branchName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">实验目的</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="experimentPurpose" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">实验内容</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="experimentContent" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">实验步骤</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="experimentStep" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">实验记录详情</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div data-role="qc-table">
                                                    <div class="tc-15-table-panel">
                                                        <div class="tc-15-table-fixed-head">
                                                            <table class="tc-15-table-box">
                                                                ...
                                                                <tr><!----> <!---->
                                                                    ...
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="记录ID"
                                                                                                   class="text-overflow">记录ID</span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="负责人ID" class="text-overflow">负责人ID</span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="负责人姓名" class="text-overflow">负责人姓名</span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="记录类型"
                                                                        ...
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><span class="tc-15-th-sort-btn"><span title="完成时间"
                                                                                                                   class="text-overflow">完成时间</span> <i
                                                        ...
                                                        <div class="tc-15-table-fixed-body"
                                                             style="min-height: 360px; height: auto; max-height: 540px;">
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">实验结论</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="experimentConclusion" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">实验备注</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="experimentNote" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
