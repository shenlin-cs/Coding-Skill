    ...
    <script type = "text/javascript" >
        ...
        window.onload = function () {
            ...
            if (getQueryVariable("NoteID") != false) {
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/getdisnote?",
                    dataType : "json",
                    data : {
                    ...
                    success:function(result){
                        ...
                        $("#discussionHeadID").html(result.data["discussionHeadID"]);
                        $("#discussionHeadName").html(result.data["discussionHeadName"]);
                        $("#discussionExcuter").html(result.data["discussionExcuter"]);
                        $("#discussionID").html(result.data["discussionID"]);
                        $("#discussionName").html(result.data["discussionName"]);
                        $("#discussionRoomID").html(result.data["discussionRoomID"]);
                        $("#discussionTime").html(result.data["discussionTime"]);
                        $("#discussionAim").html(result.data["discussionAim"]);
                        $("#discussionMedicament").html(result.data["discussionMedicament"]);
                        $("#discussionEquipment").html(result.data["discussionEquipment"]);
                        $("#discussionResult").html(result.data["discussionResult"]);
                    },
                ...
                $.ajax({
                    ...
                    success:function(result){
                        ...
                        else
                        {
                            ...
                            $("#experimentID").html("");
                            $("#experimentName").html("");
                            $("#discussionHeadID").html("");
                            $("#discussionHeadName").html("");
                            $("#discussionExcuter").html("");
                            $("#discussionID").html("");
                            $("#discussionName").html("");
                            $("#discussionRoomID").html("");
                            $("#discussionTime").html("");
                            $("#discussionAim").html("");
                            $("#discussionMedicament").html("");
                            $("#discussionEquipment").html("");
        ...
        <div class="main" id="appArea">
            <div id="developer-index" class="tea-page-root">
                <div class="manage-area auth-info-page">
                    <div class="manage-area-title"><h2>讨论记录详情</h2></div>
                        ...
                        <div class="manage-area-main-inner">
                            ...
                            <div class="tc-15-action-panel">
                                ...
                                <div data-role="qc-search" class="search-box tc-15-search m" style="width: 320px;">
                                    <div class="search-input-wrap"><input type="text" placeholder="请输入讨论记录ID查询"
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">讨论人员基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionHeadID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>讨论人员数量</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionExcuter"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionHeadName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">讨论记录详情</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>讨论ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>讨论室</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionRoomID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>讨论名称</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>讨论时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="discussionTime"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">讨论目的</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="discussionAim" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">讨论试剂</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="discussionMedicament" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">讨论设备</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="discussionEquipment" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">讨论结果</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="discussionResult" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
