...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".search-btn").click(function(){
			...
			if(text.length!=0)
	        {
	            $.ajax({
	                type : "GET",
	                url : "http://localhost:8080/FileManage/ApplicationIDQuery?",
	                dataType : "json",
	                data : {
	                	ApplicationID:text
	                },
	...
	function getPara(){
		...
		document.location.href= "dealauditrequest?id="+par; 		
	}
</script>
<body style="">
<div id="pageWrapper">
                                ...
                                <div data-role="qc-table">
                                    <div class="tc-15-table-panel">
										...
										<div class="listmessage" style="display:none;margin-top:20px">
											<lable style="font-size:15px;margin-top:10px">当前无待审核消息，休息一下吧！^-^</lable>
										</div>
                                        ...
                                        <div class="tc-15-table-fixed-body"
                                            ...
                                            <table class="tc-15-table-box tc-15-table-rowhover"
                                                ...
                                                <c:forEach items="${requestScope.audit_list}" var="audit_list">
                                                	<tbody>
		                                                <tr data-tips="">
		                                                    <td colspan="1"> 
		                                                    	<div>${audit_list.applicationID}</div>		                                                    	
		                                                   	</td>		                                                    
		                                                    <td colspan="1">
		                                                        <div>${audit_list.applicationOperateType }</div>
		                                                    </td>
		                                                    <td colspan="1">
		                                                        <div>${audit_list.applicantName }</div>
		                                                    </td>
		                                                    <td colspan="1">
		                                                        <div>${audit_list.applicationTime }</div>
		                                                    </td>
		                                                    <td colspan="1">
		                                                        <div>未审</div>
		                                                    </td>
		                                                    <td colspan="1">
		                                                        <div>${audit_list.recordtype }</div>
		                                                    </td>
		                                                    <td colspan="1">
		                                                        <div>${audit_list.clerkname }</div>
		                                                    </td>
		                                                    <td colspan="1">
		                                                        <div><a href="dealauditrequest?id=${audit_list.applicationID}">查看详情</a></div>                                                        
		                                                    </td>
		                                                </tr>
	                                                </tbody>													
												</c:forEach>
