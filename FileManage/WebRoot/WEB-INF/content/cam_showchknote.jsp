    ...
    <script type = "text/javascript" >
        ...
        window.onload = function () {
            ...
            if (getQueryVariable("NoteID") != false) {
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/getchknote?",
                    dataType : "json",
                    data : {
                    ...
                    success:function(result){
                        ...
                        $("#checkHeadID").html(result.data["checkHeadID"]);
                        $("#checkHeadName").html(result.data["checkHeadName"]);
                        $("#checkExcuter").html(result.data["checkExcuter"]);
                        $("#participantsNumber").html(result.data["participantsNumber"] +"<em>(单位：人)</em>");
                        $("#checkID").html(result.data["checkID"]);
                        $("#checkName").html(result.data["checkName"]);
                        $("#checkRoomID").html(result.data["checkRoomID"]);
                        $("#checkTime").html(result.data["checkTime"]);
                        $("#checkAim").html(result.data["checkAim"]);
                        $("#checkMedicament").html(result.data["checkMedicament"]);
                        $("#checkEquipment").html(result.data["checkEquipment"]);
                        $("#checkResult").html(result.data["checkResult"]);
                    },
        ...
        <div class="main" id="appArea">
            <div id="developer-index" class="tea-page-root">
                <div class="manage-area auth-info-page">
                    <div class="manage-area-title"><h2>检查记录详情</h2></div>
                        ...
                        <div class="manage-area-main-inner">
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">检查人员基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="checkHeadID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>检查者ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="checkExcuter"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="checkHeadName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h2 class="title">检查记录基本信息</h2></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>检查ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="checkID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>检查室</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="checkRoomID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <!--                                                                <li class="pure-text-row pure-text-row">-->
                                                                <!--                                                                    <div class="form-label"><label>检查名称</label></div>-->
                                                                <!--                                                                    <div class="form-input">-->
                                                                <!--                                                                        <div class="form-unit">-->
                                                                <!--                                                                            <div class="form-text" id="checkName"></div>-->
                                                                <!--                                                                        </div>-->
                                                                <!--                                                                    </div>-->
                                                                <!--                                                                </li>-->
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>检查时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="checkTime"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">检查目的</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="checkAim" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">检查试剂</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="checkMedicament" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">检查设备</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="checkEquipment" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">检查结果</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="checkResult" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
