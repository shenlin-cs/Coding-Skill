...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload = function(){
            ...
            if(getQueryVariable("AnimalID")!=false)
            {
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/getanimalinfo?",
                    dataType : "json",
                    data : {
                        AnimalID: getQueryVariable("AnimalID"),
                        token: sessionStorage.getItem("token")},
                    async : false,
                    success:function(result){
                        $("#animalBirthday").html(result.data["animalBirthday"]);
                        $("#animalRoomChargePerson").html(result.data["animalRoomChargePerson"]);
                        $("#animalLevel").html(result.data["animalLevel"]);
                        $("#animalWeight").html(result.data["animalWeight"]+"<em>(单位：Kg)</em>");
                        $("#animalHealth").html(result.data["animalHealth"]);
                        $("#animalSpecies").html(result.data["animalSpecies"]);
                        $("#animalRoom").html(result.data["animalRoom"]);
                        $("#animalGender").html(result.data["animalGender"]);
                        $("#animalID").html(result.data["animalID"]);
                    },
                ...
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/getsigninfbyAnimalID?",
                    dataType : "json",
                    data : {
                        LoginID: loginid,
                        AnimalID:getQueryVariable("AnimalID"),
                        ...
                        <div class="manage-area-main-inner">
                            ...
                            <div class="tc-15-action-panel">
                                ...
                                <div data-role="qc-search" class="search-box tc-15-search m" style="width: 320px;">
                                    <div class="search-input-wrap"><input type="text" placeholder="请输入动物ID查询"
                                        ...
                                        <!----></div>
                                    <input type="button" value="搜索" title="搜索" class="search-btn" id="tc-15-input-text search-button"></div>
                            </div>
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">实验动物基本信息</h3></div>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>动物ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>种类</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalSpecies"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>性别</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalGender"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>动物等级</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text"><span
                                                                                    class="text-success" id="animalLevel"></span><a
                                                                                    href="javascript:;"
                                                                                    class="tc-link-btn">了解实验动物分级</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>动物培育室</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalRoom"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>饲养员ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalRoomChargePerson" title="点击了解饲养员信息">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>出生日期</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalBirthday"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>体重</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalWeight"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>健康状况</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="animalHealth"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">实验动物体征信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                    ...
                                                    <div class="tc-15-table-panel">
                                                        <div class="tc-15-table-fixed-head">
                                                            <table class="tc-15-table-box">
                                                                ...
                                                                <tr><!----> <!---->
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="体重" class="text-overflow">体重<em>（单位：Kg）</em></span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="体温" class="text-overflow">体温<em>（单位：°C）</em></span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="脉搏" class="text-overflow">脉搏<em>（单位：次/min）</em></span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="心率" class="text-overflow">心率<em>（单位：次/min）</em></span>
                                                                        </div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="入量" class="text-overflow">入量<em>（单位：Kg）</em></span></div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><span class="tc-15-th-sort-btn"><span title="出量" class="text-overflow">出量<em>（单位：Kg）</em></span> <i class="up-sort-icon"></i></span></div>
                                                                        <i data-role="resizer" class="resize-line-icon"></i></th>
                                                                    <th class="text-left">
                                                                        <div><!----> <!----> <span title="体征记录时间" class="text-overflow">记录时间</span></div>
                                                                        <!----></th>
                                                                </tr>
                                                                </thead>
                                                            </table>
                                                        </div>
                                                        <div class="tc-15-table-fixed-body" style="min-height: 480px; height: auto; max-height: 540px;">
                                                            <table class="tc-15-table-box tc-15-table-rowhover" style="min-width: 100%;" id="tablelist">
                                                            </table>
                                                        </div>
                                                    </div> <!----></div>
