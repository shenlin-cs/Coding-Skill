            ...
            else
            {
                ...
                var j=0;
                    $.each(result.data,function(i,val){
                    	    var list="<li><span>"+val["experimentEndTime"]+"</span><a href=\""+"cam_3?ExperimentID="+val["experimentID"]+"&token="+token+"\" title=\""+val["name"]+"\">"+val["name"]+"</a></li>";
    $("#list").append(list);
    j+=1;
    })
                                ...
                                <div data-role="qc-table">
                                    <div class="tc-15-table-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">时间轴</h3></div>
                                        </div>
                                        <div class="timebox">
                                            <ul id="list">
                                            </ul>
