...
<head>
    ...
    <script type = "text/javascript" >
        ...
        window.onload = function () {
            ...
            if (getQueryVariable("NoteID") != false) {
                $.ajax({
                    type : "GET",
                    url : "http://localhost:8080/FileManage/api/getoptnote?",
                    dataType : "json",
                    data : {
                        NoteID: getQueryVariable("NoteID"),
                    ...
                    success:function(result){
                        ...
                        $("#piphoneNumber").html(result.data["piphoneNumber"]);
                        $("#piteamName").html(result.data["piteamName"]);
                        $("#experimentID").html(result.data["experimentID"]);
                        $("#experimentName").html(result.data["experimentName"]);
                        $("#operationHeadID").html(result.data["operationHeadID"]);
                        $("#operationHeadName").html(result.data["operationHeadName"]);
                        $("#operationExcuter").html(result.data["operationExcuter"]);
                        $("#participantsNumber").html(result.data["participantsNumber"] +"<em>(单位：人)</em>");
                        $("#operationID").html(result.data["operationID"]);
                        $("#operationName").html(result.data["operationName"]);
                        $("#operationRoomID").html(result.data["operationRoomID"]);
                        $("#operationTime").html(result.data["operationTime"]);
                        $("#operationAim").html(result.data["operationAim"]);
                        $("#operationMedicament").html(result.data["operationMedicament"]);
                        $("#operationEquipment").html(result.data["operationEquipment"]);
                        $("#operationResult").html(result.data["operationResult"]);
                    },
                ...
                $.ajax({
                    ...
                    success:function(result){
                        ...
                        else
                        {
                            ...
                            $("#experimentID").html("");
                            $("#experimentName").html("");
                            $("#operationHeadID").html("");
                            $("#operationHeadName").html("");
                            $("#operationExcuter").html("");
                            $("#participantsNumber").html("");
                            $("#operationID").html("");
                            $("#operationName").html("");
                            $("#operationRoomID").html("");
                            $("#operationTime").html("");
                            $("#operationAim").html("");
                            $("#operationMedicament").html("");
                            $("#operationEquipment").html("");
                            ...
                            <div class="qc-user-panel-inner J-dropdownPanel">
                                ...
                                <ul class="qc-user-voucher">
                                    ...
                                    <li><a href="http://localhost:8080/FileManage/account/invoice" data-event="nav"
                                           ...
                                           data-auth="operationPassState">发票</a></li>
                                </ul>
        ...
        <div class="main" id="appArea">
            <div id="developer-index" class="tea-page-root">
                <div class="manage-area auth-info-page">
                    <div class="manage-area-title"><h2>手术记录详情</h2></div>
                        ...
                        <div class="manage-area-main-inner">
                            ...
                            <div class="tc-15-action-panel">
                                ...
                                <div data-role="qc-search" class="search-box tc-15-search m" style="width: 320px;">
                                    <div class="search-input-wrap"><input type="text" placeholder="请输入检查记录ID查询"
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                                    ...
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                ...
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>PI团队名称</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="piteamName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                ...
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>PI联系方式</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="piphoneNumber"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="experimentName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h3 class="title">手术人员基本信息</h3></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                        ...
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    ...
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationHeadID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>手术执行者ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationExcuter"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>负责人姓名</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationHeadName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
<!--                                                                <li class="pure-text-row pure-text-row">-->
<!--                                                                    <div class="form-label"><label>参与检查数量</label></div>-->
<!--                                                                    <div class="form-input">-->
<!--                                                                        <div class="form-unit">-->
<!--                                                                            <div class="form-text" id="participantsNumber"></div>-->
<!--                                                                        </div>-->
<!--                                                                    </div>-->
<!--                                                                </li>-->
                                                            </ul>
                            ...
                            <div class="tc-g panelgroup">
                                <div class="tc-g-u-1-1">
                                    <div class="tc-panel">
                                        <div class="tc-panel-hd">
                                            <div class="col"><h2 class="title">手术记录基本信息</h2></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                                ...
                                                <div class="tc-g-u-1-3 border-right">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>手术ID</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>手术室</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationRoomID"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="tc-g-u-1-3 matchheight">
                                                    <div class="param-box ">
                                                        <div class="param-bd">
                                                            <ul class="form-list">
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>手术名称</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationName"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="pure-text-row pure-text-row">
                                                                    <div class="form-label"><label>手术时间</label></div>
                                                                    <div class="form-input">
                                                                        <div class="form-unit">
                                                                            <div class="form-text" id="operationTime"></div>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">手术目的</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="operationAim" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">手术试剂</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="operationMedicament" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">手术设备</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="operationEquipment" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                        <div class="tc-panel-hd">
                                            <div class="col"><h4 class="title">手术结果</h4></div>
                                            <div class="col"><a href="javascript:;" target="_self" class="tc-link-btn">帮助指引</a>
                                            </div>
                                        </div>
                                        <div class="tc-panel-bd">
                                            <div class="tc-g with-divider">
                                                <div class="form-module_forComment" style="margin: 0px 20px;"><div class="form-module-unit"><textarea class="tc-15-input-textarea" id="operationResult" readonly="readonly"></textarea></div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
