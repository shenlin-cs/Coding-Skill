...
<html>
  ...
  <body>
    <h3 style="text-align:center">转出记录</h3>
    <form action="insertTransferoutNote" method="post">
    <div style="text-align:center">
	    ...
	    <table style="margin-left:10px;width:98%" border='1' class="table table-striped">
	    	<div>
	    		<tr>	    		
		    		<th>转出编号</th><td><input id="TransferoutID" name="TransferoutID"/></td>
	    		</tr>
	    	</div>
	    	<div>
	    		<tr>	    		
	    	...
	    	<div>
	    		<tr>
		    		<th>转出对象</th><td><input id="transferobject" name="transferobject"/></td>
		    		<th>转出时间</th><td>
