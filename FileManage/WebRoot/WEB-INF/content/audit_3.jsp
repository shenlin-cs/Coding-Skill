...
<head>
    ...
    <script type="text/javascript">
        ...
        function getPara(){
			...
			var par1=document.getElementById("AuditorID").value;
			var par2=document.getElementById("AuditorName").value;
			var par3=document.getElementById("AuditTime").value;
			var par5=document.getElementById("Feedback").value;	
			var obj=document.getElementsByName("auditpnp");
			var par4;			
			...
			document.location.href= "auditpass?ApplicationID="+par+"&AuditorID="+par1+"&AuditorName="+par2+"&AuditTime="+par3+"&AuditResult="+par4+"&Feedback="+par5; 		
		
		}	
		
		$(document).ready(function () {
		    $("#AuditorID").bind('input propertychange','none',function () {
		        var text=$(this).val();
		        if(text.length!=0)
		        {
		            $.ajax({
		                type : "GET",
		                url : "http://localhost:8080/FileManage/AuditorNameQuery?",
		                dataType : "json",
		                data : {
		                	AuditorID:text
		                },
		                ...
		                success:function(result){
		                    if(result&&result.code==0){
								...
								$("#AuditorName")[0].value=result.data.staffName; 
                    ...
                    <div class="work-order-datail-left">
                                        ...
                                        <div class="con-right-box" style="margin-top:20px">
                                            <form>                                                
                                                                ...
                                                                <div class="param-bd">
                                                                    <ul class="form-list">
                                                                        <li class="pure-text-row pure-text-row">
                                                                            ...
                                                                            <div class="form-input">
                                                                                <div class="form-unit">
                                                                                   <span style="display:inline-block;float:left; white-space:nowrap;">
																		    			<input id="AuditorID" name="AuditorID" style="width:100%"/>
																		    			<a class="info1"><i class="iconfont">&#xe657;</i></a>
																						<a class="info2"><i class="iconfont">&#xe668;</i></a>
																					</span>
																				</div>
                                                                            </div>
                                                                        </li>  
                                                                        <li class="pure-text-row pure-text-row">
                                                                            ...
                                                                            <div class="form-input">
                                                                                <div class="form-unit">
                                                                                    <div class="form-text">
                                                                                    	<label><input type="radio" id="auditpnp"  name="auditpnp" value="审核通过">审核通过</label>
																						<label><input type="radio" id="auditpnp"  name="auditpnp" value="审核不通过">审核不通过</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </li>                                                                      
                                                                ...
                                                                <div class="param-bd">
                                                                    <ul class="form-list">
                                                                        <li class="pure-text-row pure-text-row">
                                                                            ...
                                                                            <div class="form-input">
                                                                                <input style="width:100%" id="AuditorName" name="AuditorName"/>
                                                                            </div>
                                                                        </li>  
                                                                        <li class="pure-text-row pure-text-row">
                                                                            <div class="form-label"><label></label></div>
                                                                        ...
                                                                        <li class="pure-text-row pure-text-row">
                                                                            ...
                                                                            <div class="form-input">
                                                                                <input type="text" class="Wdate"
																					...
																					id="AuditTime" name="AuditTime" style="width:100%">
                                                                            </div>
                                                                        </li>  
                                                                        <li class="pure-text-row pure-text-row">
                                                                            <div class="form-label"><label></label></div>
                                                ...
                                                <div class="form-module-unit" style="margin-top:10px"><textarea
						                                    ...
						                                    id="Feedback" name="Feedback">${requestScope.feedbackmessage}</textarea></div>						                        
                                                <div class="work-order-topbar">
                                                    <div class="work-order-topbar-right">
                        ...
                        <div style="text-align:center">      
                        	<button type="button"  style="margin-bottom: 10px;">
	                        	<a href="autoaudit?ApplicationID=${requestScope.Application_Information_content.applicationID}" class="tc-15-btn forComment">
	                        		自动审核 </a>
	                        </button>   
	                        <button type="button"  style="margin-bottom: 10px;">
	                        ...
	                        <button type="button" style="margin-bottom: 10px;" >
	                        	<a href= "javascript:" onclick="getPara()" class="tc-15-btn forComment">
	                        	提交审核结果</a></button>
						</div>
                    </div>
                </div>
